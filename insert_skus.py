...
# SKU data
# SOURCE: CIE_Doc4b_Golden_Test_Data_Pack.pdf §3.2 — expected_outputs.channel_decisions use google_sge/amazon/ai_assistants/own_website
# FIX: TS-13 — aligned with database/seeds/golden_test_data.json (was shopify/gmc)
skus_data = [
  {
