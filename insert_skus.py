...
# SOURCE: CLAUDE.md Section 19 — no hardcoded credentials (CHAN-04 / E3)
...
skus_data = [
  {
    ...
    "expected_outputs": {
      ...
      "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 95}, "gmc": {"decision": "COMPETE", "readiness": 92}, "active_channels": 2},
  ...
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "ALL_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 94}, "gmc": {"decision": "COMPETE", "readiness": 89}, "active_channels": 2}, "maturity": {"core_fields": 40, "authority": 20, "channel_readiness": 22, "ai_visibility": 12, "total": 94, "level": "Gold"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "ALL_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 88}, "gmc": {"decision": "COMPETE", "readiness": 76}, "active_channels": 2}, "maturity": {"core_fields": 36, "authority": 16, "channel_readiness": 20, "ai_visibility": 8, "total": 80, "level": "Gold"}}
  },
  {
    ...
    "authority": {},
    "faqs": [],
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "N/A", "G4": "N/A", "G5": "N/A", "G6": "PASS", "G7": "N/A", "overall": "HARVEST_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 65}, "gmc": {"decision": "SKIP", "readiness": 0}, "active_channels": 1}, "maturity": {"core_fields": 20, "authority": 5, "channel_readiness": 15, "ai_visibility": 0, "total": 40, "level": "Silver"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "ALL_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 96}, "gmc": {"decision": "COMPETE", "readiness": 94}, "active_channels": 2}, "maturity": {"core_fields": 40, "authority": 20, "channel_readiness": 23, "ai_visibility": 13, "total": 96, "level": "Gold"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "FAIL", "G4_reason": "ai_answer_block_chars=242, minimum=250", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "GATE_FAIL", "submit_enabled": False}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 91}, "gmc": {"decision": "COMPETE", "readiness": 88}, "active_channels": 2}, "maturity": {"core_fields": 35, "authority": 18, "channel_readiness": 21, "ai_visibility": 10, "total": 84, "level": "Gold"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "ALL_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 85}, "gmc": {"decision": "COMPETE", "readiness": 72}, "active_channels": 2}, "maturity": {"core_fields": 34, "authority": 14, "channel_readiness": 19, "ai_visibility": 7, "total": 74, "level": "Silver"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "FAIL", "G5_reason": "not_for is empty, minimum 1 required", "G6": "PASS", "G7": "PASS", "overall": "GATE_FAIL", "submit_enabled": False}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 82}, "gmc": {"decision": "SKIP", "readiness": 0}, "active_channels": 1}, "maturity": {"core_fields": 32, "authority": 14, "channel_readiness": 18, "ai_visibility": 6, "total": 70, "level": "Silver"}}
  },
  {
    ...
    "expected_outputs": {"gate_results": {"G1": "PASS", "G2": "PASS", "G3": "PASS", "G4": "PASS", "G5": "PASS", "G6": "PASS", "G7": "PASS", "overall": "ALL_PASS", "submit_enabled": True}, "channel_decisions": {"shopify": {"decision": "COMPETE", "readiness": 93}, "gmc": {"decision": "COMPETE", "readiness": 91}, "active_channels": 2}, "maturity": {"core_fields": 40, "authority": 20, "channel_readiness": 22, "ai_visibility": 12, "total": 94, "level": "Gold"}}
  },
  {
    ...
    "authority": {},
    "faqs": [],
    "expected_outputs": {"gate_results": {"G1": "N/A", "G2": "N/A", "G3": "N/A", "G4": "N/A", "G5": "N/A", "G6": "PASS", "G7": "N/A", "overall": "KILL_EXCLUDED", "submit_enabled": False, "submit_visible": False}, "channel_decisions": {"shopify": {"decision": "SKIP", "readiness": 0}, "gmc": {"decision": "SKIP", "readiness": 0}, "active_channels": 0}, "maturity": {"core_fields": None, "authority": None, "channel_readiness": None, "ai_visibility": None, "total": None, "level": "Excluded"}}
  }
]
