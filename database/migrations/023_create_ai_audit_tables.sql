...
CREATE TABLE ai_golden_queries (
    question_id VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci PRIMARY KEY, -- e.g., CAB-Q01
    ...
    success_criteria VARCHAR(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    locked_until DATE,
...
CREATE TABLE ai_audit_results (
    ...
    response_snippet TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, -- First 500 chars
