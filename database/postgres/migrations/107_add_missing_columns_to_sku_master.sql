...
SET @sql := IF(@col_exists = 0,
  "ALTER TABLE sku_master ADD COLUMN maturity_level TEXT NOT NULL DEFAULT 'bronze'",
...
SET @sql := IF(@col_exists = 0,
  "ALTER TABLE sku_master ADD COLUMN decay_status TEXT NOT NULL DEFAULT 'none'",
