...
(gen_random_uuid(), 'admin@cie.internal.com',   '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin',   'User',  true),
(gen_random_uuid(), 'writer@cie.internal.com',  '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Writer',  'User',  true),
(gen_random_uuid(), 'kpi_reviewer@cie.internal.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'KPI Reviewer', 'User',  true)
ON DUPLICATE KEY UPDATE updated_at = CURRENT_TIMESTAMP;

-- Admin: ADMIN
INSERT IGNORE INTO user_roles (user_id, role_id)
SELECT u.id, r.id FROM users u CROSS JOIN roles r
WHERE u.email = 'admin@cie.internal.com' AND r.name = 'ADMIN';
