...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_product_id VARCHAR(50) NULL DEFAULT NULL AFTER updated_by',
  'SELECT 1'
);
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_variant_id VARCHAR(50) NULL DEFAULT NULL AFTER shopify_product_id',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_status VARCHAR(20) NULL DEFAULT NULL AFTER shopify_synced_at',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_title VARCHAR(255) NULL DEFAULT NULL AFTER shopify_status',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_handle VARCHAR(255) NULL DEFAULT NULL AFTER shopify_title',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_body_html MEDIUMTEXT NULL DEFAULT NULL AFTER shopify_handle',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_image_url VARCHAR(500) NULL DEFAULT NULL AFTER shopify_compare_at_price',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_product_type VARCHAR(255) NULL DEFAULT NULL AFTER shopify_image_url',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_vendor VARCHAR(255) NULL DEFAULT NULL AFTER shopify_product_type',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN shopify_tags TEXT NULL DEFAULT NULL AFTER shopify_vendor',
  'SELECT 1'
);
-- TODO(pg): removed MySQL PREPARE/EXECUTE block;
