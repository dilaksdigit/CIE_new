...
SET @sql = IF(@col_exists = 0,
  'ALTER TABLE skus ADD COLUMN erp_data_incomplete BOOLEAN NOT NULL DEFAULT 0 COMMENT ''SOURCE: CIE_v232_Cloud_Briefing §11 — null/default ERP fields'' AFTER erp_return_rate_pct',
  'SELECT 1'
);
